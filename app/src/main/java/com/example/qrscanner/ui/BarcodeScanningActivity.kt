...
import com.example.qrscanner.analyzer.MLKitBarCodeAnalyzer
import com.example.qrscanner.analyzer.ScanningResultListener
import com.example.qrscanner.analyzer.ZXingBarCodeAnalyzer
            ...
            camera.cameraInfo.torchState.observe(this) {
                it?.let { torchState ->
                    if (torchState == TorchState.ON) {
                        flashEnabled = true
                        binding.ivFlashControl.setImageResource(R.drawable.ic_rount_flash_on)
                    } else {
                        flashEnabled = false
