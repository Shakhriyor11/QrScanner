...
import com.example.qrscanner.databinding.FragmentScannerResultListDialogBinding
...
class ScannerResultDialog(private val listener: DialogDismissListener) : BottomSheetDialogFragment() {
    ...
    private lateinit var binding: FragmentScannerResultListDialogBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentScannerResultListDialogBinding.inflate(
